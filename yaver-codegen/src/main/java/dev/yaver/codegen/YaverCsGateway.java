...
public class YaverCsGateway extends AbstractCSharpCodegen {
    ...
    public YaverCsGateway() {
        ...
        embeddedTemplateDir = templateDir = "yaver-cs-gateway";
    ...
    public String getHelp() {
        return "Generates C# gateway layer (FastEndpoints + gRPC commands) for Yaver modular monolith.";
    }

    @Override
    public String getName() {
        return "yaver-cs-gateway";
    }
