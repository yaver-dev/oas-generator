...
public class YaverCsFastendpoints extends AbstractCSharpCodegen {
    ...
    public YaverCsFastendpoints() {
        ...
        embeddedTemplateDir = templateDir = "yaver-cs-fastendpoints";
